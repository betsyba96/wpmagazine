		...
		$template = array(
			...
			'body' =>
				sprintf(
					...
					'[Betsyba] [gnana.betsyba@goavega.com]'
				) . "\n"
				. sprintf(
				...
				. "\n" . '[Our Magazine World messages are sent sucessfully]' . "\n\n"
				. '-- ' . "\n"
				. sprintf(
					/* translators: 1: blog name, 2: blog URL */
					__( 'This is a notification that a contact form was submitted on your website (%1$s %2$s).', 'contact-form-7' ),
					'[Our Magazine World]',
					'[http://localhost/magazine]'
				),
			'recipient' => '[gnana.betsyba@goavega.com]',
			'additional_headers' => 'Reply-To: [gnana.betsyba@goavega.com]',
			'attachments' => '',
			'use_html' => 0,
			'exclude_blank' => 0,
		);
