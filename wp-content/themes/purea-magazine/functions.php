...
function purea_magazine_setup() {
	...
	register_nav_menus( array(
		...
		'social' => esc_html__( 'Sidebar Social', 'purea-magazine' ),
		'footer-social' => esc_html__( 'Footer Social', 'purea-magazine' ),
	) );
...
function purea_magazine_widgets_init() {
	...
	if('left-sidebar'===get_theme_mod( 'purea_magazine_home_page_layout','both-sidebars') || 'both-sidebars'===get_theme_mod( 'purea_magazine_home_page_layout','both-sidebars') ) :
		register_sidebar( array(
	...
	if('right-sidebar'===get_theme_mod( 'purea_magazine_home_page_layout','both-sidebars') || 'both-sidebars'===get_theme_mod( 'purea_magazine_home_page_layout','both-sidebars') ) :
		register_sidebar( array(
	...
	if(true===get_theme_mod( 'purea_magazine_enable_menu_left_sidebar',false)) :
        register_sidebar( array(
            'name'          => esc_html__( 'Menu Left Sidebar', 'purea-magazine' ),
            'id'            => 'menuleftsidebar',
            'description'   => esc_html__( 'Add widgets here.', 'purea-magazine' ),
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget'  => '</div>',
...
function purea_magazine_scripts() {
	...
	wp_register_style( 'purea-magazine-style', get_template_directory_uri() . '/style.css', array(), wp_get_theme()->get('Version'));
	wp_style_add_data( 'purea-magazine-style', 'rtl', 'replace' );
	wp_enqueue_style( 'purea-magazine-style' );
	
	wp_register_style( 'purea-magazine-blocks-frontend', get_template_directory_uri() . '/css/blocks-frontend.css', array(), wp_get_theme()->get('Version'));
	wp_style_add_data( 'purea-magazine-blocks-frontend', 'rtl', 'replace' );
	wp_enqueue_style( 'purea-magazine-blocks-frontend' );
...
function purea_magazine_block_editor_width_styles() {
	...
	wp_register_style( 'purea_magazine-blocks-style', trailingslashit( get_template_directory_uri() ) . 'css/blocks-style.css', array(), '1.0.0', 'all' );
	wp_style_add_data( 'purea_magazine-blocks-style', 'rtl', 'replace' );
	wp_enqueue_style( 'purea_magazine-blocks-style' );
