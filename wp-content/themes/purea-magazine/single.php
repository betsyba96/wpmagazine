...
$prevarticle = esc_html(get_theme_mod( 'purea_magazine_single_post_previous_article_text', esc_html__('Previous Article','purea-magazine')));
$nextarticle = esc_html(get_theme_mod( 'purea_magazine_single_post_next_article_text', esc_html__('Next Article','purea-magazine')));
